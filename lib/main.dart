    ...
    return Scaffold(
            ...
            children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      const Text("Note-Taking App",
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 24)),
                    ],
                  ),
                  // FIX: Replaced pravatar.cc with ui-avatars to avoid CORS errors on web
                  CircleAvatar(
                    radius: 22,
              ...
              Expanded(
                child: GridView.count(
                  ...
                  crossAxisSpacing: 15,
                  children: [
                    _buildCategoryCard(context, "Personal",
                        Icons.description_outlined, Colors.purpleAccent),
                    _buildCategoryCard(context, "Academic",
                        Icons.school_outlined, Colors.blueAccent),
                    _buildCategoryCard(context, "Work", Icons.work_outline,
                        Colors.orangeAccent),
                    _buildCategoryCard(context, "Others",
                        Icons.folder_open_outlined, Colors.pinkAccent),
                  ],
                ),
              ),
            ],
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            IconButton(
                icon: const Icon(Icons.note_alt_outlined), onPressed: () {}),
            IconButton(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (_) => NotesListScreen(category: title)));
      },
      child: Container(
        decoration: BoxDecoration(
            color: Colors.white,
  ...
  Widget _buildAddNoteCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: const Color(0xFF6B5BF2).withValues(alpha: 0.2)),
      ),
      child: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: const Color(0xFF6B5BF2), style: BorderStyle.solid),
              ),
            ...
            const Text("New note",
                style: TextStyle(
                    color: Color(0xFF6B5BF2), fontWeight: FontWeight.w600)),
          ],
        ),
      ),
    );
